...
export default function Home() {
  ...
  // Stable reference for initialMessages — only changes when activeId changes
  ...
  const onChatUpdate = useCallback(
    (
      ...
      // Auto-name from first user message if still "New Dashboard"
  ...
  // Display spec: chat spec (from streaming) takes priority, then dashboard's saved spec
