...
export const catalog = defineCatalog(schema, {
  components: {
    ...
    ScatterChart: {
      ...
      description:
        'Scatter plot for comparing two numeric dimensions. Provide datasets with {x, y}[] point data. Use xLabel/yLabel for axis titles and yFormat for value formatting.',
      example: {
